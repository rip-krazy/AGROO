                    ...
                    <div class="flex flex-col flex-1 px-4 space-y-1">
                        ...
                        <div class="dropdown mb-2 @if(request()->routeIs('memo.*') || request()->routeIs('arsip.*')) active @endif">
                            ...
                            <div class="dropdown-content ml-8 mt-1 space-y-1">
                                <a href="{{ route('memo.index') }}" class="@if(request()->routeIs('memo.*')) bg-indigo-900 @endif flex items-center px-4 py-2 text-sm text-white rounded-lg hover:bg-indigo-700">
                                ...
                                <a href="{{ route('arsip.index') }}" class="@if(request()->routeIs('arsip.*')) bg-indigo-900 @endif flex items-center px-4 py-2 text-sm text-white rounded-lg hover:bg-indigo-700">
                                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
